...
const DOCK_ICONS: Record<string, React.ReactNode> = {
  ...
  settings: (
    <svg width="17" height="17" viewBox="0 0 20 20" fill="none" stroke="white" strokeWidth="1.5">
      <rect x="8" y="2" width="4" height="2" fill="white" stroke="none"/>
      <rect x="8" y="16" width="4" height="2" fill="white" stroke="none"/>
      <rect x="2" y="8" width="2" height="4" fill="white" stroke="none"/>
      <rect x="16" y="8" width="2" height="4" fill="white" stroke="none"/>
      <rect x="6" y="6" width="8" height="8" fill="none"/>
      <rect x="9" y="9" width="2" height="2" fill="white" stroke="none"/>
    </svg>
  ),
  terminal: (
    <svg width="17" height="17" viewBox="0 0 20 20" fill="none" stroke="white" strokeWidth="1.5">
